...
export default  function Trips(){
    ...
    return (
        <div className="container mx-auto flex flex-col p-5 justify-center items-center">
            <h1 className="text-primaryDarker font-semibold text-xl">Viagens encontradas</h1>
            <h2 className="text-grayPrimary font-medium mb-5">{trips.length > 0 ? 'Listamos as melhores viagens para você' : 'Não encontramos nenhuma viagen!'}</h2>
